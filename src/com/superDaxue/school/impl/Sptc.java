...
public class Sptc implements ISchool{
	...
	public JSONObject doLogin(String username, String password,String checkNum) {
		...
		nvps.add(new BasicNameValuePair("imgDL.x", "17"));
		nvps.add(new BasicNameValuePair("imgDL.y", "11"));
		nvps.addAll(headers);
