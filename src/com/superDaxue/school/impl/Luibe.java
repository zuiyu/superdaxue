...
public class Luibe implements ISchool{
	private String cookie;
	private String baseurl="219.216.227.241:9980";
	...
	public JSONObject doLogin(String username, String password,String checkNum) {
		...
		nvps.add(new BasicNameValuePair("zjh1", ""));
		nvps.add(new BasicNameValuePair("tips", ""));
		nvps.add(new BasicNameValuePair("lx", ""));
		nvps.add(new BasicNameValuePair("evalue", ""));
		nvps.add(new BasicNameValuePair("eflag", ""));
		nvps.add(new BasicNameValuePair("fs", ""));
		nvps.add(new BasicNameValuePair("dzslh", ""));
		...
		mapHeader.add(new BasicNameValuePair("Referer","http://"+baseurl+"/logout.do"));
		...
		if(temp.indexOf("mainFrame.jsp")!=-1){
