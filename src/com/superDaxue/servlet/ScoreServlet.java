...
public class ScoreServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//if(request.getSession().getAttribute("scoreJsonArray")==null){
			...
			if(list!=null){
				double gpa=0;
				if("hhuwtian".equalsIgnoreCase(school)){
					gpa=getGPA2(list);
				}else{
					gpa=getGPA(list);
				}
	...
	private double getGPA(List<Courses> list){
		...
		for(Courses courses:list){
			...
			try {
				...
				if("优".equals(score)||"优秀".equals(score)){
					grade=95;
				}
				...
				else if("中".equals(score)||"中等".equals(score)||"通过".equals(score)){
					grade=65;
				}
				else if("差".equals(score)||"及格".equals(score)){
					grade=60;
				}
	...
	private double getGPA2(List<Courses> list){
		...
		for(Courses courses:list){
			...
			try {
				...
				else if("良好".equals(score)||"良".equals(score)){
					grade=87;
				}
				else if("中".equals(score)||"中等".equals(score)){
					grade=78;
				}
